							...
							<div class="card-body pt-0">
								...
								<form action="{{route('unit.store')}}" method="POST">
									...
									<div class="form-group">
										<input type="text" name="unit_name" class="form-control"  value="{{old('unit_name')}}" id="inputName" placeholder="Name">
									</div>
									<div class="form-group">
										<input type="textarea" class="form-control"  placeholder="no_of_units" value="{{old('no_of_units')}}" name="no_of_units">
									</div>
									<div class="form-group">
