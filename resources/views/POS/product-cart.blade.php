...
@section('content')
															...
															<img src="{{URL::asset('assets/img/ecommerce/01.jpg')}}" alt="img" class="h-60 w-60">
																...
																<div class="media-body">
																	<div class="card-item-desc mt-0">
																		<h6 class="font-weight-semibold mt-0 text-uppercase"> {{$details['product_name']}}</h6>
        ...
        @endif 
								...
								<div class="shopping-cart-footer  border-top-0">
									...
									<div class="column text-lg">total: <span class="tx-20 font-weight-bold mr-2">{{$total}}</span>
								    
								</div>
								<div class="column text-lg">vat:<span class="tx-20 font-weight-bold mr-2">{{$vat}}</span>
								</div>
								<div class="column text-lg">total with vat:
									<span class="tx-20 font-weight-bold mr-2">{{$total_with_vat}}</span>
							</div>
								</div>
								<div class="shopping-cart-footer">
									...
									<a class="btn btn-success" href="#">Test</a></div>
								</div>
							</div>
						</div>
					</div>
